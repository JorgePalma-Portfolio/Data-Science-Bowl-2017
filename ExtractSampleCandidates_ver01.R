...
set.seed(1)
dt00 <- dt00[ sample( 1:nrow(dt00), nrow(dt00)*0.3),]
...
dt05 <- rbind(dt00,dt01,dt02,dt03,dt11,dt12,dt13,dt14,dt16,dt19,dt111,dt112,dt113,dt115,dt116,dt117,dt118,dt21,dt22,dt23,dt24,dt26,dt29,
