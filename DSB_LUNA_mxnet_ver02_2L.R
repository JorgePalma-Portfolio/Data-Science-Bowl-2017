...
# Third Pass
# sensitivity 0.8238035 true positive rate (w disease)
# specificity 0.9906293 true negative rate (w/o disease) 
# cutoff      1.0000000
# AUC         0.9072164
...
# Additional Third Pass
# sensitivity 0.9097610
# specificity 0.9850243
# cutoff      1.0000000
# AUC         0.9473926
...
train <- fread('input/LUNA/train03.csv', header=TRUE)
test  <- fread('input/LUNA/test03.csv', header=TRUE)
...
# first conv
conv1      <- mx.symbol.Convolution(data=data, kernel=c(5,5), num_filter=20, stride=c(1,1))
...
# second conv
conv2      <- mx.symbol.Convolution(data=pool1, kernel=c(5,5), num_filter=40, stride=c(1,1))
...
batchnorm4 <- mx.symbol.BatchNorm(data=fc1, fix_gamma=FALSE)
...
#learning.rate=0.09 for the second pass
#learning.rate=0.09 for the third pass
